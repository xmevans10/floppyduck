...
struct BotCharacter: Identifiable, Hashable {
    ...
    static let all: [BotCharacter] = [
        ...
        BotCharacter(
            ...
            accentColor: Color(red: 0.95, green: 0.80, blue: 0.18), targetScore: 30),
    ]
